      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1><span class="badge badge-danger">Items Deleted  Table</span> </h1>
         ...
         {{-- For success To restore user --}}
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Items Deleted Table</h3>
            </div>
                  ...
                  <tbody>
                    ...
                    @foreach ($items as $item)
                        ...
                        <tr>
                          ...
                          <td>
                              <a  style="margin: 5px ; text-decoration: none;" href="{{ route('item.restore',['id' =>$item->id])}}">
                                  <i  style="color:blue;" class="fas fa-trash-restore"></i>
                              </a>
                              <a  style="margin: 5px; text-decoration: none;" href="{{ route('item.hdelete',['id' =>$item->id])}}">
