      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1><span class="badge badge-primary">Sliders Table</span> </h1>
                  ...
                  <tbody>
                    ...
                    @foreach ($sliders as $slider)
                        ...
                        <tr>
                          ...
                          <td>
                              <a  style="margin: 5px ; text-decoration: none;" href="{{ route('slider.edit',['id' => $slider->id])}}">
                                  <i  style="color:blue;" class="fas fa-edit"></i>
                              </a>
                              <a  style="margin: 5px; text-decoration: none;" href="{{ route('slider.deleteSlider',['id' => $slider->id])}}">
